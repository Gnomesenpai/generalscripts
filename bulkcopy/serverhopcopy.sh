...
rsync --progress  -vhz "/${base2}/bulkcopy/serverhop.cfg" game@aus.moevsmachine.tf:$mvmx10
rsync --progress  -vhz "/${base2}/bulkcopy/serverhop.cfg" game@aus.moevsmachine.tf:$joinblu
rsync --progress  -vhz "/${base2}/bulkcopy/serverhop.cfg" game@aus.moevsmachine.tf:$stt
